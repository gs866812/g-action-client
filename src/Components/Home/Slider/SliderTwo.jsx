...
const SliderTwo = () => {
    return (
        <div 
        className="flex flex-col items-center gap-5 text-white px-6 lg:py-[100px] py-10 bg-blend-darken bg-[url('https://iili.io/JwsG3fR.jpg')] bg-no-repeat bg-top bg-cover bg-[#00000080]">
            ...
            <p className="lg:text-2xl text-[18px] text-center lg:w-1/2">
                From web development to digital marketing, our expertise covers every facet of your digital strategy, providing seamless management for your online endeavors.
            </p>
